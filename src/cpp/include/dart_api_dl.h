...
#define DART_NATIVE_API_DL_SYMBOLS(F)                                                                                  \
  ...
  F(Dart_NewNativePort, Dart_Port_DL,                                                                                  \
    (const char *name, Dart_NativeMessageHandler_DL handler, bool handle_concurrently))                                \
...
#define DART_API_DL_SYMBOLS(F)                                                                                         \
  ...
  F(Dart_SendPortGetIdEx, Dart_Handle, (Dart_Handle port, Dart_PortEx_DL * portex_id))                                 \
...
#define DART_API_DEPRECATED_DL_SYMBOLS(F)                                                                              \
  ...
  F(Dart_UpdateFinalizableExternalSize, void,                                                                          \
    (Dart_FinalizableHandle object, Dart_Handle strong_ref_to_object, intptr_t external_allocation_size))
